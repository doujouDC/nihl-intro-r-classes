...
Figure 6 displays the first and second elements of ggplot's grammar of graphics. We will go through these steps in detail.

![](images/healy-ggplot-vertical-flow-01.png){width="3.55in"}

Figure 6: Schematic of how ggplot works: Data to mapping.

Figure 7 displays the third and fourth elements of ggplot's grammar of graphics
