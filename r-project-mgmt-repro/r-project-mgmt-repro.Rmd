...
[At this link](https://github.com/signup), you may sign into your GitHub account or create one if you have not already. I have already created a [repository](https://github.com/doujouDC/nihl-intro-r-series.git) for this class. I will need to copy the repository URL before I create the project in RStudio.
