...
easier. For example, in a dynamic document (R-markdown) so that the results automatically update when the data are changed.
...
For several papers, we have made our data, code and analyses available as an Experiment Package on Bioconductor. When I came up for tenure, I cited all of these packages as research output of my lab. Generally, making your
analyses available in this way will help you to build a reputation
for being an honest and careful researcher.
