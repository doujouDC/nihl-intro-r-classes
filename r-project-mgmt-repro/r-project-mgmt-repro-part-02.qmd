...
You might have noticed that there are some special comments at the top of the code block. These comments use `#| (the hash pipe!)`. `#|` provides the cell options. When the document is rendered, this code chunk will look like this \[Figure 15\]:

![](images/quarto-code-chunk-rendered.png){width="640"}

Figure 15: Rendered version of a code-chunk.
...
```{r Creating Air Quality Figure, warning=FALSE}
#| label: fig-airquality
#| fig-cap: Temperature and ozone level.
...
**STOPPED on 2022-08-15**
https://rstudio-conf-2022.github.io/rmd-to-quarto/materials/3-computation/slides/computation.html#/setting-knitr-options
