...
+-------------------------------------------------+------------------------------------------------------------------+
| ![](images/quarto-icon-smaller.png){width="25"} | You want to learn about Quarto, the next-generation of RMarkdown |
+-------------------------------------------------+------------------------------------------------------------------+
...
![](images/python-vscode.png){width="640"}
...
Figure 14 is showng the same document using the "source editor" mode. Notice the symbols scattered throughout the text (#, \*, \<\>). Those are examples of R Markdown syntax, which is a flavor of Markdown syntax, an easy and quick, human-readable markup language for document styling.
...
Figure 16 is displaying the markdown that generates the text and links displayed below.

![](images/inline-element-links.png){width="640"}

Figure 16: Inline elements: links and images.
...
Figure 19: Code options available in R-markdown.
...
![](images/quarto-rstudio-render.png){width="640"}
