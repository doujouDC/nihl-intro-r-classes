...
[At this link](https://github.com/signup), you may sign into your GitHub account or create one if you have not already. Figure 5 is displaying the repositories in my GitHub account.

![](images/git-hub-01.png){width="6.5in"}

Figure 5: My repository homepage in GitHub.

I have already created a [repository](https://github.com/doujouDC/nihl-intro-r-series.git) for this class. However Figure 6 is displaying the Create a New Repository screen. [Figure 6].

![](images/git-hub-02.png){width="6.5in"}

Figure 6: Creating a new repository on GitHub.

Once your repository is created, you will need to copy the repository URL before you create the project in RStudio. Figure 7 shows the 3 different methods for creating a URL: (1) https, (2) SSH, or (3) GitHub CLI. We have already created our PAT to use with the https option.

![](images/git-hub-03.png){width="6.5in"}

Figure 7: Creating a link to a GitHub repository.
