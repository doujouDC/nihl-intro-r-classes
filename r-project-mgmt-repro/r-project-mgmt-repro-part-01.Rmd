...
2.  Select the Commit icon on the Git Panel
3.  Add a short commit message, and select the commit button.

![](images/git-08.png){width="640"}

Figure 23: Adding a commit message and committing the changes.

2.  Once you commit your screen will refresh showing the changes

![](images/git-09.png){width="640"}

Figure 24: Changes after the commit

2.  Close the Git Commit screen
3.  Select the Push button to send the changes to GitHub
