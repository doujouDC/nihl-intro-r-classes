...
12. You should be able to work with GitHub now, i.e. push and pull.
13. Remember, if you are already syncing on another computer, you will have to enter this new PAT before you push or pull.
...
[At this link](https://github.com/signup), you may sign into your GitHub account or create one if you have not already. Figure 9 is displaying the repositories in my GitHub account.

![](images/git-hub-01.png){width="640"}

Figure 9: My repository homepage in GitHub.

I have already created a [repository](https://github.com/doujouDC/nihl-intro-r-series.git) for this class. However Figure 10 is displaying the Create a New Repository screen. [Figure 10].

![](images/git-hub-02.png){width="640"}

Figure 10: Creating a new repository on GitHub.

Once your repository is created, you will need to copy the repository URL before you create the project in RStudio. Figure 11 shows the 3 different methods for creating a URL: (1) https, (2) SSH, or (3) GitHub CLI. We have already created our PAT to use with the https option.

![](images/git-hub-03.png){width="640"}

Figure 11: Creating a link to a GitHub repository.
...
6.  This screen is where you enter the repository URL that you copied from GitHub [Figure 11].

![](images/new-project-03.png){width="640"}

Figure 11: New project wizard - entering the repository URL.

7.  Open up the repository that we created in GitHub and copy the `https` URL [Figure 12].

![](images/new-project-04.png){width="640"}

Figure 12: Copying a `https` repository URL from GitHub.
...
Figure 13: Menu bar options for working with GIT
...
Figure 15: A humorous look at version control.
...
Recall that a repository or repo is just a directory of files that Git manages holistically. A commit functions like a snapshot of all the files in the repo, at a specific moment. Figure 16 a look at a fictional analysis of the iris data, focusing on the evolution of a script, `iris.R.`

![](images/commit-diff-sha-tag.png){width="642"}

Figure 16: Partial commit history that looks at diffs, commit messages, SHA, and tags.
...
<https://carpentries-incubator.github.io/Reproducible-Publications-with-RStudio/05-setup-versioning/index.html>
