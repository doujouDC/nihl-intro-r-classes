...
```{r}
write_csv(surveys_complete, file = "../nihl-intro-r-classes-data-raw/surveys-complete.csv")
```



# Read in Full Portal Rodent Data

```{r}
portal_rodent <- read_csv("https://raw.githubusercontent.com/weecology/PortalData/main/Rodents/Portal_rodent.csv")

write_csv(portal_rodent, file = "../data-raw/portal-rodent.csv")
```